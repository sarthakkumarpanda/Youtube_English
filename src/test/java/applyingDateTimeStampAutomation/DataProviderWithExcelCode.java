...
public class DataProviderWithExcelCode {
	...
	public Object[][] rediffData() throws Exception {
		Object[][] data = DataProviderWithExcelCode.readDataFromExcelSheet("LoginRediff");
		return data;
	}
	
	public static Object[][] readDataFromExcelSheet(String sheetName) throws Exception {
		ip = new FileInputStream(System.getProperty("user.dir") + "\\src\\test\\java\\applyingDateTimeStampAutomation\\ExcelDataCode.xlsx");
